...
const Cards = ({ img, price, title, NewPrice, OldPrice, num, rating = 0 }) => {
  return (
    <div className="w-[270px] h-[350px] font-poppins"> {/* أضفت font-poppins هنا */}
      ...
      <div className="pt-[16px]">
        <span className="text-base font-medium font-poppins leading-normal">{title}</span> {/* تم تعديل text-sm إلى text-base */}
        <div className="py-[8px] flex items-center">
          ...
          {OldPrice && ( // عرض السعر القديم فقط إذا كان موجودًا
        ...
        <div>
          <div className="flex items-center">
            <RatingStars rating={rating} /> {/* استخدام مكون النجوم */}
            <span className="text-sm text-gray-500 ml-2">({num})</span> {/* تم تعديل font-poppins */}
          </div>
        </div>
      </div>
    </div>
